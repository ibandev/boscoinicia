...
skel.registerPlugin("panels", function() {
    var b = {
        ...
        parseInit: function(e) {
            ...
            case "togglePanel":
            case "panelToggle":
                e.css("-webkit-tap-highlight-color", "rgba(0,0,0,0)").css("cursor", "pointer");
                c = function(c) {
                    c.preventDefault();
                    c.stopPropagation();
                    if (b.cache.activePanel)
                        return b.cache.activePanel._skel_panels_close(),
                    !1;
                    jQuery(this);
            ...
            case "navList":
                ...
                c.each(function() {
                    ...
                    d.push('<a class="link depth-' + c + '" href="' + b.attr("href") + '"><span class="indent-' + c + '"></span>' + b.text() + "</a>")
                    });
        ...
        lockView: function(e) {
            ...
            b.cache.pageWrapper.bind("click.lock", function(c) {
                c.preventDefault();
                c.stopPropagation();
                b.cache.activePanel && b.cache.activePanel._skel_panels_close()
                });
        ...
        resumeElement: function(e) {
            b.cache[e.type + "s"][e.id].find("*").each(function() {
            ...
            case "panel":
                ...
                "ios" == b._.vars.deviceType && d.find("input,select,textarea").focus(function(c) {
                    ...
                    window.setTimeout(function() {
                        var c = b.cache.window._skel_panels_scrollPos,
                ...
                break;
            case "overlay":
                d.css("z-index", b.config.baseZIndex).css("position", "fixed").addClass("skel-panels-overlay"),
                d.css("width", c.width).css("height", c.height),
                (h = b.positions.overlays[c.position]) || (c.position = "top-left", h = b.positions.overlays[c.position]),
                d.addClass("skel-panels-overlay-" + c.position).data("skel-panels-overlay-position", c.position),
                b._.iterate(h, function(e) {
                    d.css(e, h[e]);
        ...
        initJQueryUtilityFuncs: function() {
            ...
            jQuery.fn._skel_panels_xcssValue = function(b, d) {
                return jQuery(this).css(b, d).css(b, "-moz-" + d).css(b, "-webkit-" + d).css(b, "-o-" + d).css(b, "-ms-" + d)
                };
            jQuery.fn._skel_panels_xcssProperty = function(b, d) {
                return jQuery(this).css(b, d).css("-moz-" + b, d).css("-webkit-" + b, d).css("-o-" + b, d).css("-ms-" + b, d)
                };
            jQuery.fn._skel_panels_xcss = function(b, d) {
                return jQuery(this).css(b, d).css("-moz-" + b, "-moz-" + d).css("-webkit-" + b, "-webkit-" + d).css("-o-" + b, "-o-" + d).css("-ms-" + b, "-ms-" + d)
                };
            ...
            if (b.config.useTransform && 10 <= b._.vars.IEVersion && (!b.config.transformBreakpoints || b._.hasActive(b.config.transformBreakpoints.split(","))))
